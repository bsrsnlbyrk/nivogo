...
const About = () => {
  return (
    <div>
      <StartYourBusiness />
      <p className="text-center md:mt-[41px] md:text-[56px] md:font-bold md:leading-[84px] md:text-[#323B4B]">
        Hayata Döndür ile Dolaplardaki Serveti ve Okyanusları Serbest
        Bırakıyoruz
      </p>
      <p className="text-center md:mt-8 md:text-2xl md:leading-9 md:text-[#636363]">
